...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.FeaturedViewHolder> {
    ...
    public RecyclerAdapter(ArrayList<Product> contentList, OnSingleItemClicked listener, Context context) {
    ...
    public FeaturedViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.top_pics_card, parent, false);
    ...
    public static class FeaturedViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public FeaturedViewHolder(@NonNull View itemView, OnSingleItemClicked listener) {
            super(itemView);
            product_image = itemView.findViewById(R.id.top_pics_image);
            product_title = itemView.findViewById(R.id.top_pics_title);
            product_author = itemView.findViewById(R.id.top_pics_author);
            this.listener = listener;
